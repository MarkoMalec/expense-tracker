...
function CategoryCard({ category }: { category: Category }) {
  return (
    <div className="relative py-5 flex border-separate flex-col justify-between rounded-md border shadow-md shadow-black/[0.1] dark:shadow-white/[0.1]">
      ...
      <div className="absolute top-0 left-0 p-1 flex items-center justify-between w-full gap-2">
        <EditCategoryDialog
          category={category}
          trigger={
            <Button
              variant={"ghost"}
              className="group flex border-separate items-center gap-2 rounded-t-none text-muted-foreground hover:text-red-600 hover:bg-transparent p-2"
            >
